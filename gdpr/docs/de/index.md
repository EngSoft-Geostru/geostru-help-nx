...
Ihre Daten und die von Ihnen hochgeladenen Dateien werden auf Servern in der **Europäischen Union** und in der **Schweiz** gespeichert — einem Land, das von der Europäischen Kommission als Land mit **angemessenem Schutzniveau** anerkannt ist — und werden **bei der Übertragung verschlüsselt** (HTTPS/TLS).

## Wer darauf zugreifen kann

Die Daten sind **pro Kunde isoliert**: Nur Sie und die von Ihnen autorisierten Personen können auf Ihre Projekte, Dateien und Aufmaße zugreifen. Der Zugriff ist durch eine eigene Authentifizierung geschützt.
...
Sie können Ihre DSGVO-Rechte jederzeit ausüben — **Auskunft, Berichtigung, Löschung, Einschränkung, Übertragbarkeit und Widerspruch** — indem Sie an **[privacy@geostru.ai](mailto:privacy@geostru.ai)** schreiben.

## Anbieter, die uns unterstützen (Unterauftragsverarbeiter)

Zur Erbringung des Dienstes greifen wir auf ausgewählte Anbieter zurück, jeweils mit eigenen Auftragsverarbeitungsverträgen:

| Anbieter | Tätigkeit |
|---|---|
| **Google** | Cloud-Infrastruktur (Hosting EU/Schweiz) und Funktionen der künstlichen Intelligenz |
| **Stripe** | Zahlungsabwicklung |

## Aufbewahrung und Löschung

Wir bewahren die Daten so lange auf, wie es zur Erbringung des Dienstes und zur Erfüllung gesetzlicher Pflichten erforderlich ist. Sie können jederzeit die Löschung Ihrer Daten verlangen.
