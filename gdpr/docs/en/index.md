...
Your data and the files you upload are hosted on servers located in the **European Union** and **Switzerland** — a country recognised by the European Commission as providing an **adequate level of protection** — and are **encrypted in transit** (HTTPS/TLS).

## Who can access it

Data is **isolated per customer**: only you, and the people you authorise, can access your projects, files and estimates. Access is protected by dedicated authentication.
...
You may exercise your GDPR rights at any time — **access, rectification, erasure, restriction, portability and objection** — by writing to **[privacy@geostru.ai](mailto:privacy@geostru.ai)**.

## Providers that support us (sub-processors)

To deliver the service we rely on selected providers, each with their own data processing agreements:

| Provider | Activity |
|---|---|
| **Google** | cloud infrastructure (EU/Switzerland hosting) and artificial intelligence features |
| **Stripe** | payment processing |

## Retention and erasure

We keep data for as long as necessary to provide the service and to meet legal obligations. You can request erasure of your data at any time.
